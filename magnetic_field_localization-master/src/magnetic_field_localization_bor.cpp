...
int main (int argc, char** argv){
    ros::init(argc, argv, "magnetic_field_localization_bor");
    ros::NodeHandle nh;
    ...
    //ros::Publisher test_pub_3 = nh.advertise<geometry_msgs::Vector3>("power_line_vector", 20);
...
//TODO
            ...
            //test_pub_3.publish(power_line_vector);
