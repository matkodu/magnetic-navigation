...
def get_trajectory():
    ...
    for i in range(499):
        p=JointTrajectoryPoint();
        p.positions.append(0)#0
        p.positions.append(4)#1
        p.positions.append(i*0.001 + 0.5)#2
        p.positions.append(0)#3
        p.positions.append(0)#4
        p.positions.append(1.5)#5
        p.positions.append(0)#6
    ...
    for i in range(1999):
        p=JointTrajectoryPoint();
        p.positions.append(0)#0
        p.positions.append(4 - i*0.001)#1
